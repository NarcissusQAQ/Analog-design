...
//电阻屏芯片连接引脚	   
#define PEN  		PFin(0)  	//PF10 INT
#define DOUT 		PFin(1)   	//PF8  MISO
#define TDIN 		PEout(6)  	//PF9  MOSI
#define TCLK 		PEout(4)  	//PB1  SCLK
#define TCS  		PEout(5)  	//PB2  CS  
...
//void TP_Save_Adjdata(void);//保存触屏校准参数
//u8 TP_Get_Adjdata(void);//读取触屏校准参数
																 
void TP_Draw_Point(u16 x,u16 y,u16 color);
void paint(void);
void rtp_test(void);
extern u16 buff[200][2],buff_length;
